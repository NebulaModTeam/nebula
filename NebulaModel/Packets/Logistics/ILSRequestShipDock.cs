...
namespace NebulaModel.Packets.Logistics
{
    public class ILSRequestShipDock
    {
        ...
        public ILSRequestShipDock(int stationGId, Vector3 shipDockPos, Quaternion shipDockRot, int[] shipOtherGId, int[] shipIndex, Double3[] shipPos, Float4[] shipRot, Double3[] shipPPosTemp, Float4[] shipPRotTemp)
        {
