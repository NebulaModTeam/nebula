namespace NebulaModel.Packets.Factory.PowerTower
{
    public class PowerTowerUserLoadingResponse
    {
        ...
        public PowerTowerUserLoadingResponse(int PlanetId, int NetId, int NodeId, int PowerAmount, long EnergyCapacity, long EnergyRequired, long EnergyServed, long EnergyAccumulated, long EnergyExchanged, bool Charging)
        {
