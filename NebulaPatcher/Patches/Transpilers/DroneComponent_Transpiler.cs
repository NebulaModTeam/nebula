...
{
    delegate double patchEnergyChangeIfNeeded(double mechaValue, double subValue, int owner);
                ...
                matcher
                    .Repeat(matcher => matcher
                        .InsertAndAdvance(
                            ...
                            HarmonyLib.Transpilers.EmitDelegate<patchEnergyChangeIfNeeded>((double mechaValue, double subValue, int owner) =>
                            {
