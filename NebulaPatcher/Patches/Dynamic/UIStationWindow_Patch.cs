...
namespace NebulaPatcher.Patches.Dynamic
{
    ...
    class UIStationWindow_Patch
    {
        ...
        {
            if (SimulatedWorld.Instance.Initialized && !ILSShipManager.PatchLockILS && (StationUIManager.UIIsSyncedStage == 2 || LocalPlayer.Instance.IsMasterClient))
            {
        ...
        {
            if (!SimulatedWorld.Instance.Initialized || LocalPlayer.Instance.IsMasterClient || StationUIManager.UIIsSyncedStage > 0 || GameMain.localPlanet == null || !__instance.active)
            {
                return true;
            }
            ...
            if (stationComponent != null && GameMain.localPlanet != null)
            {
                ...
                LocalPlayer.Instance.SendPacket(new StationUIInitialSyncRequest(stationComponent.planetId, stationComponent.id, stationComponent.gid));
        ...
        {
            if (!SimulatedWorld.Instance.Initialized || LocalPlayer.Instance.IsMasterClient || StationUIManager.UIIsSyncedStage == 2)
            {
                return true;
            }
            return false;
        ...
        public static void _OnClose_Postfix(UIStationWindow __instance)
        {
            ...
            if (__instance.stationId != 0 || StationUIManager.UIStationId != 0)
            {
                ...
                LocalPlayer.Instance.SendPacket(new StationSubscribeUIUpdates(false, __instance.transport.planet.id, __instance.transport.stationPool[StationUIManager.UIStationId].id, __instance.transport.stationPool[StationUIManager.UIStationId].gid));
