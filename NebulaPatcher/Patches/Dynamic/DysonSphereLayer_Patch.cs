...
internal class DysonSphereLayer_Patch
{
    ...
    public static void NewDysonNode_Prefix(DysonSphereLayer __instance, int protoId, Vector3 pos)
    {
        ...
        Multiplayer.Session.Network.SendToAll(new DysonSphereAddNodePacket(__instance.starData.index, __instance.id,
    ...
    public static void NewDysonFrame_Prefix(DysonSphereLayer __instance, int protoId, int nodeAId, int nodeBId, bool euler)
    {
        ...
        Multiplayer.Session.Network.SendToAll(new DysonSphereAddFramePacket(__instance.starData.index, __instance.id,
    ...
    public static void RemoveDysonFrame_Prefix(DysonSphereLayer __instance, int frameId)
    {
        if (Multiplayer.IsActive && !Multiplayer.Session.DysonSpheres.IsIncomingRequest)
        {
            Multiplayer.Session.Network.SendToAll(new DysonSphereRemoveFramePacket(__instance.starData.index, __instance.id,
                frameId));
        }
    }
    ...
    public static void RemoveDysonNode_Prefix(DysonSphereLayer __instance, int nodeId)
    {
        if (Multiplayer.IsActive && !Multiplayer.Session.DysonSpheres.IsIncomingRequest)
        {
            Multiplayer.Session.Network.SendToAll(new DysonSphereRemoveNodePacket(__instance.starData.index, __instance.id,
                nodeId));
        }
    }
    ...
    public static void NewDysonShell_Prefix(DysonSphereLayer __instance, int protoId, List<int> nodeIds)
    {
        ...
        Multiplayer.Session.Network.SendToAll(new DysonSphereAddShellPacket(__instance.starData.index, __instance.id,
    ...
    public static void RemoveDysonShell_Prefix(DysonSphereLayer __instance, int shellId)
    {
        if (Multiplayer.IsActive && !Multiplayer.Session.DysonSpheres.IsIncomingRequest)
        {
            Multiplayer.Session.Network.SendToAll(new DysonSphereRemoveShellPacket(__instance.starData.index, __instance.id,
                shellId));
        }
    }
    ...
    public static void InitOrbitRotation_Prefix(DysonSphereLayer __instance, Quaternion __1)
    {
        ...
        {
            Multiplayer.Session.Network.SendToAll(new DysonSphereEditLayerPacket(__instance.starData.index, __instance.id,
                __1));
        }
    }
}
