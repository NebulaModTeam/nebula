...
namespace NebulaPatcher.Patches.Dynamic
{
    ...
    class Player_Patch
    {
        ...
        public static bool RemoveLayer_Prefix()
        {
            ...
            return !SimulatedWorld.Initialized || FactoryManager.PacketAuthor == LocalPlayer.PlayerId || (LocalPlayer.IsMasterClient && FactoryManager.PacketAuthor == -1) || (!FactoryManager.IsIncomingRequest && !FactoryManager.IsIncomingRequest);
        }
