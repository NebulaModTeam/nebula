...
namespace NebulaPatcher.Patches.Dynamic
{
    ...
    class StationComponent_Patch
    {
        ...
        {
            if (SimulatedWorld.Instance.Initialized && LocalPlayer.Instance.IsMasterClient && __instance.isStellar)
            {
                ...
                LocalPlayer.Instance.SendPacket(new ILSShipDataUpdate(__instance.gid, shipIndex, otherGId, direction, itemId));
            }
        }
