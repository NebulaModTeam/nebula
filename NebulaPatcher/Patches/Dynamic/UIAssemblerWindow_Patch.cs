...
namespace NebulaPatcher.Patches.Dynamic
{
    ...
    class UIAssemblerWindow_Patch
    {
        ...
        {
            LocalPlayer.SendPacketToLocalPlanet(new AssemblerRecipeEventPacket(GameMain.data.localPlanet.factoryIndex, __instance.assemblerId, recipe.ID));
        }
        ...
        {
            LocalPlayer.SendPacketToLocalPlanet(new AssemblerUpdateProducesPacket(1, __instance.factorySystem.assemblerPool[__instance.assemblerId].produced[1], GameMain.data.localPlanet.factoryIndex, __instance.assemblerId));
        }
