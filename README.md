...
This mod has API, that makes easier for other mod developers to be compatible with Nebula. If you are a mod developer and you want to your mods to be compatible, follow instructions [here](https://github.com/hubastard/nebula/wiki/Nebula-mod-API). Also you can always join our [Discord Server](https://discord.gg/UHeB2QvgDa) for help with using API.
